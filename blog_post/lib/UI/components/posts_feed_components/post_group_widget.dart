                  ...
                  IconButton(
                      ...
                      onPressed: () async {
                        ...
                        await postStoreRead.fetchPostInfo(
                            elem.idPost, profileStoreRead.getEmail, true);
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                    ...
                    if (profileStoreRead.isUserAuth) ...[
                      IconButton(
                          onPressed: () async => await postStoreWatch
                              .fetchLikedPosts(elem, profileStoreRead.getEmail),
                          icon: Icon(
                            elem.stateLike == true
                                ? Icons.thumb_up
                                ...
                                if (profileStoreRead.isUserAuth)
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      maxLines: null,
                                      controller: commentStoreWatch
                                          .getCommentTextController,
                                      onChanged: commentStoreRead.setCommentText,
                                      decoration: InputDecoration(
                                          labelText: "Комментарий",
                                          suffixIcon: IconButton(
                                              onPressed: () async {
                                                final lastName = profileStoreRead.getLastName;
                                                final name = profileStoreRead.getName;
                                                ...
                                                (lastName != null &&
                                                    ...
                                                    ? [
                                                        await commentStoreWatch.newComment(
                                                                ...
                                                                profileStoreRead
                                                                    .getEmail),
                                                        await commentStoreWatch.fetchAllComments(
                                                                elem.idPost)
                                                      ]
